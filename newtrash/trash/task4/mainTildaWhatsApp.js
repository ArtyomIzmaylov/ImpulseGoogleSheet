    ...
    MessageExtractor.prototype.extract = function () {
        ...
        switch (this.managerExtractor.extract().student.status) {
            ...
            case "Проведено":
                ...
                break;
            default:
                message = "\u041F\u0440\u0438\u0432\u0435\u0442, ".concat(this.managerExtractor.extract().student.name, "! \u041C\u044B \u0437\u0430\u043F\u0438\u0441\u0430\u043B\u0438 \u0442\u0435\u0431\u044F \u043D\u0430 \u0437\u0430\u043D\u044F\u0442\u0438\u0435, \u043A\u043E\u0442\u043E\u0440\u043E\u0435 \u043F\u0440\u043E\u0439\u0434\u0435\u0442 ").concat(this.managerExtractor.extract().student.status, ". \u0425\u043E\u0440\u043E\u0448\u0435\u0433\u043E \u0443\u0440\u043E\u043A\u0430 :)\n\u0418\u043C\u044F \u0442\u0432\u043E\u0435\u0433\u043E \u043C\u0435\u043D\u0435\u0434\u0436\u0435\u0440\u0430: ").concat(this.managerExtractor.extract().manager.name, "\n\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430: ").concat(this.managerExtractor.extract().manager.phone, "\n\u0414\u043B\u044F \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u0438\u044F \u043D\u0430\u043F\u0438\u0448\u0438 \u043C\u043D\u0435 \u0447\u0442\u043E-\u0443\u0433\u043E\u0434\u043D\u043E \u0432 \u043E\u0442\u0432\u0435\u0442\u043D\u043E\u043C \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0438)");
        }
...
var WhatsAppMessenger = /** @class */ (function () {
    function WhatsAppMessenger(whatsAppMessengerConfig) {
        this.whatsAppMessengerConfig = whatsAppMessengerConfig;
    }
    WhatsAppMessenger.prototype.send = function () {
        return __awaiter(this, void 0, void 0, function () {
            var messageConfig, response, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        messageConfig = this.whatsAppMessengerConfig.createMessage();
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, fetch(this.whatsAppMessengerConfig.getApiUrl(), messageConfig)];
                    case 2:
                        response = _a.sent();
    ...
    WhatsAppMessenger.prototype.sendSync = function () {
        var messageConfig = this.whatsAppMessengerConfig.createMessage();
        var response = UrlFetchApp.fetch(this.whatsAppMessengerConfig.getApiUrl(), messageConfig);
    };
    return WhatsAppMessenger;
}());
var WhatsAppMessengerConfig = /** @class */ (function () {
    function WhatsAppMessengerConfig(channelId, token, messageExtractor, studentExtractor) {
        this.token = token;
    ...
    WhatsAppMessengerConfig.prototype.getApiUrl = function () {
        return this.apiUrl;
    };
    WhatsAppMessengerConfig.prototype.createMessage = function () {
        var payload = {
    ...
    return WhatsAppMessengerConfig;
}());
function sendMessageToWhatsApp(inputDataManager, inputDataStudent, channelId, token, inputDataStudentFromTildaStatus) {
    ...
    new WhatsAppMessenger(new WhatsAppMessengerConfig(channelId, token, new MessageExtractor(new ManagerExtractor(new StudentExtractor(studentData), new ManagerRepository(managersCollection).getByNick(new StudentExtractor(studentData).extract().manager))), new StudentExtractor(studentData))).sendSync();
}
/*
