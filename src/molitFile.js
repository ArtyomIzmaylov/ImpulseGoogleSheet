    ...
    MessageExtractor.prototype.extract = function () {
        ...
        switch (this.managerExtractor.extract().student.status) {
            ...
            case "Проведено":
                ...
                break;
            default:
                message = "\u041D\u0435\u043F\u043E\u043D\u044F\u0442\u043D\u044B\u0439 \u0441\u0442\u0430\u0442\u0443\u0441: ".concat(this.managerExtractor.extract().student.status);
        }
...
//CONFIG
var botToken = '6169349504:AAFKvAVRcmW1kDukQ4fUyc8kmrhAfocLKDA';
//MAIN
function main() {
    new TelegramMessenger(new TelegramMessengerConfig(botToken, new MessageExtractor(new ManagerExtractor(new StudentExtractor(), new ManagerRepository().getByNick(new StudentExtractor().extract().manager))), new StudentExtractor())).sendSync();
}
